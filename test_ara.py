...
#heuristic = Puzzle.pdb_1          # una heurística basada en pattern databases que usted debe implementar
...
for prob in range(0, num_problems):
    init = problems[prob]
    s = Ara(init, heuristic, 10, 80000) # agregar un tercer parámetro una vez que lo hayas transformado en Weighted A*
